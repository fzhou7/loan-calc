function calculate() {
	...
	if (isFinite(monthly)) {
		...
		try {		// catch any errors that occur within these curly braces
			getLenders(amount.value, apro.value, years.value, zipcode.value);
		}
...
// This storage feature will not work in some browsers (Firefox, eg.)
// if you run the example from a local file:// URL.
...
// a list of links to local lenders interested in making loans.
// This example does not actually include a working implementation of such a lender-finding
...
function getLenders(amount, apr, years, zipcode) {
	...
	// at some later time when the HTTP server's response arrives.
	// This kind of asynchronous programming is very common in client-side JS.
